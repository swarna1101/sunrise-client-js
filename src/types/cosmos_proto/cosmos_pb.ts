 ...
 */
export const InterfaceDescriptorSchema: GenMessage<InterfaceDescriptor> = /*@__PURE__*/
 ...
 */
export const ScalarDescriptorSchema: GenMessage<ScalarDescriptor> = /*@__PURE__*/
